    ...
    switch (currentStep) {
      case 0:
        return (
          <div className="flex flex-col gap-6">
            <div className="mb-4">
              <h2 className="text-xl font-semibold text-default-200">Investment Purpose</h2>
              <p className="text-small text-default-400">Tell us about your investment goals</p>
            </div>
            <InvestmentProfile
      ...
      case 1:
        return (
          <div className="flex flex-col gap-6">
            <div className="mb-4">
              <h2 className="text-xl font-semibold text-default-200">Investment Experience</h2>
              <p className="text-small text-default-400">Tell us about your investment experience and risk tolerance</p>
            </div>
            <InvestmentProfile
              purpose={formData.investmentPurpose}
              setPurpose={(value) =>
      ...
      case 2:
        return (
          <div className="flex flex-col gap-6">
            <div className="mb-4">
              <h2 className="text-xl font-semibold text-default-200">Financial Information</h2>
              <p className="text-small text-default-400">Tell us about your financial situation</p>
            </div>
            <FinancialInfo
  ...
  return (
    <div className="min-h-screen bg-background p-4 md:p-8">
      <Card className="max-w-4xl mx-auto bg-content1">
        <CardHeader>
          <h1 className="text-2xl font-bold text-default-200">Investor Onboarding</h1>
        </CardHeader>
        <CardBody>
